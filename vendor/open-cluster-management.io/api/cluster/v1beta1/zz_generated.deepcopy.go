...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedClusterLabel) DeepCopyInto(out *ManagedClusterLabel) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedClusterLabel.
func (in *ManagedClusterLabel) DeepCopy() *ManagedClusterLabel {
	if in == nil {
		return nil
	}
	out := new(ManagedClusterLabel)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedClusterSelector) DeepCopyInto(out *ManagedClusterSelector) {
	*out = *in
	if in.ExclusiveLabel != nil {
		in, out := &in.ExclusiveLabel, &out.ExclusiveLabel
		*out = new(ManagedClusterLabel)
		**out = **in
	}
	return
