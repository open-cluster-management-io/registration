// Package helpers contains a config checker util, this is copied from:
// https://github.com/open-cluster-management-io/addon-framework/blob/main/pkg/utils/config_checker.go
package helpers
